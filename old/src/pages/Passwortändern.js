                ...
                <div className="left-sidebar sidebar-shadow active">
	                <div className="left-sidebar-inner">
	                  <ul className="vertical-nav-menu">
	                    <li>
	                        <Link to="/"><i className="metismenu-icon lnr-layers" /> <span>Dashboard</span></Link>
	                    </li>
	                    <li>
	                    ...
	                    <li className="mm-active">
	                        <Link to="passwortändern"><i className="metismenu-icon lnr-cog" /><span>Passwort ändern</span></Link>
	                    </li>
	                  </ul>
	                </div>
	            </div>
